...
[لغة العمل ووحدة الحجم](docs/TOOLS.md#작품-언어와-분량-단위)، ولسجل التحقق راجع
[سجل التنفيذ متعدد اللغات](https://github.com/fbwndrud/vibelore/blob/main/docs/research/MULTILINGUAL_IMPLEMENTATION.md).

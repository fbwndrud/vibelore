...
> **역사적 설계 기록.** 이 설계는 0.4.0에서 구현되어 출시됐다. 현재 계약은
> [작품 언어와 분량 단위](TOOLS.md#작품-언어와-분량-단위)와 CHANGELOG 0.4.0을 기준으로 하며, 아래의 상태·브랜치·작업 폴더는
> 설계 당시(2026-09-09)의 기록이다.

작성일: 2026-09-09. 설계 당시 상태: **5차 검토 완료, 구현 착수 가능한 설계**. 당시에는 구현·회귀 검증을 아직 수행하지 않았다.

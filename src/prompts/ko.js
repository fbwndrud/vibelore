...
export const phrases = {
  ...
  context: {
    ...
    contextOverflow: (actualTokens, maxTokens) => `전체 집필 컨텍스트가 ${actualTokens} 토큰으로 ${maxTokens} 토큰 예산을 넘었습니다. 이 화를 줄이거나 다시 계획하거나, 활성 자료를 줄이세요.`,
    mandatoryOverflow: '필수 정사(세계 사실·활성 떡밥)가 컨텍스트 예산에 들어가지 않습니다. 이 화를 줄이거나 다시 계획하거나, 활성 자료를 줄이세요.',

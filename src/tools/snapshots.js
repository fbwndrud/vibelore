...
const infrastructure = new Set(['publication', 'snapshots', 'rollback-archives', 'rollback-pending.json', 'project.lock', 'project.lock.cleanup']);
...
export async function resumePendingRollback({ store, failAt = null }) {
  ...
  // Old authorizations, runs, model exchanges and search caches stay in the archive.

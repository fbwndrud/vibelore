...
const ENUMS = new Set(['recontextualizesSceneIds', 'sceneOrder', 'depthMode', 'surfaceEase', 'conceptPacing', 'inferenceLoad', 'complexityRamp', 'phase', 'hookType', 'confidenceTarget', 'selectedCandidate', 'winnerId', 'candidateId', 'askedQuestionIds', 'weakDimensions', 'povCharacter', 'foregroundCharacters', 'cast', 'charactersPresent', 'choiceOwner', 'agendaIds', 'hooksTouched', 'sourceStep', 'ageBand', 'salienceClass', 'tier', 'viewpoint', 'scopePolicy', 'runtimeVersion', 'contractVersion', 'policyRevision', 'memoryVisibility', 'addressForm', 'relationType']);

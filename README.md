...
[![Showcase](https://img.shields.io/badge/showcase-%EA%B8%B8%20%EC%9C%84%EC%9D%98%20%EB%B2%88%EA%B0%9C-orange)](https://fbwndrud.github.io/vibelore/showcase/thundertrail/)
...
<sub>vibelore로 쓴 소설 『길 위의 번개』 1~3화를 세 호스트가 각각 각색하고 같은 이미지 모델로 그린 실제 결과입니다. 검토 판정·프롬프트·비용까지 [쇼케이스](https://fbwndrud.github.io/vibelore/showcase/thundertrail/)와 [모델 비교](https://fbwndrud.github.io/vibelore/showcase/thundertrail/compare.html)에서 가감 없이 볼 수 있습니다.</sub>

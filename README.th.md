...
ข้อกำหนด: Node.js 22 ขึ้นไป

รีโพซิทอรีนี้เป็นปลั๊กอิน Codex ที่มี `.codex-plugin/plugin.json` อยู่ด้วย เมื่อติดตั้งเป็นปลั๊กอิน
สกิลสัมภาษณ์ค้นหาแนวทางของงานเขียนและเซิร์ฟเวอร์ MCP จะถูกโหลดพร้อมกัน โดยไม่ต้องระบุ
ตำแหน่งของรีโพซิทอรีในการตั้งค่าด้วยตนเอง

เมื่อเชื่อมต่อรีโพซิทอรีโดยตรงจากโฮสต์ MCP อื่น ให้รันดังนี้
...
[บันทึกการพัฒนาระบบหลายภาษา](docs/research/MULTILINGUAL_IMPLEMENTATION.md)
